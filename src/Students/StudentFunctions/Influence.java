...
public class Influence {
    ...
    public static double getInfluence(int points, int absences, int passed, int answered, int timesPicked) {
        return (-(POINTS_WEIGHT * points) + (ABSENCES_WEIGHT * absences) + (PASSED_WEIGHT * passed) - (ANSWERED_WEIGHT * answered) - (TIMES_PICKED_WEIGHT * timesPicked));
    }
}